...
Finally, the dice of single model on the test set is **0.736**. The dice of fusion model on the test set is **0.744** and the detection AUC is **0.986**. The memory of inference stage is **7.3G** when we set batch is 8 and the inference time is **9.5s** per patient.
