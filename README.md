...
> Our team ranked fourth in objective results and ranked first in subjective results. Finally, we got the fourth place in this challenge. You can access the [source data](https://pan.baidu.com/s/1NRgV2FCtCeHt2vc3Pmjo8w) and [pretrained model](https://pan.baidu.com/s/1pa8NC09nZnLq3Cs37TduXg). And our final presentation PPT is [as follows](https://github.com/ShawnBIT/AI-Challenger-Retinal-Edema-Segmentation/blob/master/materials/final-pre.pdf).
